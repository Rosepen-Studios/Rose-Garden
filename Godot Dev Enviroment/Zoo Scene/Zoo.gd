...
func _ready() -> void:
	DisplayServer.window_set_position(Vector2(DisplayServer.window_get_position().x+58,DisplayServer.window_get_position().y-254))
	DisplayServer.window_set_size(Vector2(1400,1804))
